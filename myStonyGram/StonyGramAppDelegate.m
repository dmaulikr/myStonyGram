...
@implementation StonyGramAppDelegate
...
{
    return [(StonyGramAppDelegate *)[UIApplication sharedApplication].delegate managedObjectContext];
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"photoModel" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"myStonyGram.sqlite"];
